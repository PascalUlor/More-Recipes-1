...
/**
 * @description renders a recipe from popular recipes list
 * @method PopularRecipe
 * 
 * @param { object } popularRecipe - object of single popular recipe
 * 
 * @returns { jsx } jsx - displays PopularRecipe component
 */
  ...
  <li className="list-group-item">
    ...
    <p className="text-muted w-100 text-center">
      <i className="fa fa-user text-info" aria-hidden="true">
        </i> {popularRecipe.User.fullName}
    </p>
    <div className="text-center w-100">
      <small className="text-success pr-1">
        <i className="fa fa-thumbs-o-up" aria-hidden="true">
        </i> {popularRecipe.upvotes}
      </small>
