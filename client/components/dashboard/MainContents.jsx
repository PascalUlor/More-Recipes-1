			...
			<section className="cover">
				<div className="cover-caption">
					<div className="col">
						...
						<p className="lead text-muted" style={{ fontFamily: 'fantasy' }}>Begin your adventure of creating awesome recipes
					...
					<div className="col-12 col-sm-12 col-md-12 col-lg-4">
						<div className="card">
							...
							<div className="card-img-overlay">
								<h5 className="card-title text-white">Create or View your special recipes</h5>
					...
					<div className="col-12 col-sm-12 col-md-12 col-lg-4">
						<div className="card">
							<img className="card-img img-fluid" src="/images/food2.jpg"
								alt="Card image"/>
							<div className="card-img-overlay">
								<h5 className="card-title text-white">View your favourite recipes</h5>
					...
					<div className="col-12 col-sm-12 col-md-12 col-lg-4">
						<div className="card">
							<img className="card-img img-fluid" src="/images/food3.jpg"
								alt="Card image"/>
							<div className="card-img-overlay">
								<h5 className="card-title text-white">Get a list of all available recipes</h5>
