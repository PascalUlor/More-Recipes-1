...
class EditRecipeModal extends Component {
    ...
    render() {
        ...
        return (
            <div className="modal fade" id="editRecipeModal" tabIndex="-1" role="dialog" aria-labelledby="editRecipe" aria-hidden="true">
                        ...
                        <form role="form" onSubmit={this.handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-md-12 col-lg-4 text-gray-dark mt-3">
                                    <img src={currentImageSrc} className="img-thumbnail img-fluid mb-3" style={{ width: '250px', height: '250px' }} alt="recipe image"/>
                                </div>
                            </div>
                            ...
                            <div className="modal-footer">
								...
								{ !isRecipeUpdating ? 'Update Recipe' : <span>Updating... <Spinner size={20} /></span> }
								</button>
                            </div>
                        </form>
                    </div>
