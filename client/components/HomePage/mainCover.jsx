                ...
                <section className="cover">
                    <div className="cover-caption">
                        <div className="col">
                            ...
                            <Link className="btn btn-lg btn-warning mt-3" to="/api/v1/users/signup" role="button">Get Started</Link>
                            <p className="lead beautify">Already Registered?
                                <Link className="btn btn-link" to="/api/v1/users/signin" role="button">Sign In</Link>
                            </p>
                        </div>
                    </div>
                </section>
