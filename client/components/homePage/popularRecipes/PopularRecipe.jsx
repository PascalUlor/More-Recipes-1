...
/**
 * @description displays a single popular recipe
 * @method PopularRecipe
 * 
 * @param { object } popularRecipe - object of a single popular recipe
 * 
 * @returns { jsx } jsx - renders PopularRecipe component
 */
    ...
    <div className="card mb-4">
      ...
      <div className="card-body pt-1 pb-2">
        ...
        <p className="text-muted w-100 text-center">
          ...
          </i> {popularRecipe.User.fullName}</p>
